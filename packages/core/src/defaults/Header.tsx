...
const ToggleDark: React.FC = () => {
  ...
  return (
    <div className="dm-toggle" onClick={toggleDark}>
      <div className="dm-toggle-track">
        <div className="dm-toggle-track-check">
          <img
        ...
        <div className="dm-toggle-track-x">
          <img
